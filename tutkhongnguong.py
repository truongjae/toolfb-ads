...
def set_country_and_currentcy(cookies,fb_dtsg,account_id):
	...
	data = {
		'fb_dtsg': fb_dtsg,
		'variables': '{"input":{"client_mutation_id":"3","actor_id":"'+myID+'","billable_account_payment_legacy_account_id":"'+account_id+'","currency":"HUF","logging_data":{"logging_counter":13,"logging_id":"113367954"},"tax":{"business_address":{"city":"","country_code":"HU","state":"","street1":"","street2":"","zip":""},"business_name":"","is_personal_use":false,"second_tax_id":"","second_tax_id_type":null,"tax_exempt":false,"tax_id":"","tax_id_type":"NONE"},"timezone":"Asia/Jakarta"}}',
...
def auto_add_card(acc,option):
	...
	cookies_login = getCookie(login(acc.tk,acc.mk,acc.fa))
	print(cookies_login)
	# cookies = convert_cookie_to_json(acc.cookies)
	cookies = convert_cookie_to_json(cookies_login)
	fb_dtsg = get_fb_dtsg(cookies)
	print(fb_dtsg)
