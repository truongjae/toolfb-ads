...
def set_country_and_currentcy_lol(cookies,fb_dtsg,account_id):
	try:
		...
		data = {
			'fb_dtsg': fb_dtsg,
			'variables': '{"input":{"client_mutation_id":"2","actor_id":"'+myID+'","billable_account_payment_legacy_account_id":"'+account_id+'","currency":"CNY","logging_data":{"logging_counter":10,"logging_id":"2085628828"},"tax":{"business_address":{"city":"","country_code":"BD","state":"","street1":"","street2":"","zip":""},"business_name":"","email":"","is_personal_use":false,"phone_number":"","second_tax_id":"","second_tax_id_type":null,"tax_exempt":false,"tax_id":"","tax_id_type":"NONE","tax_registration_status":""},"timezone":"Asia/Jakarta"}}',
			'doc_id': '5428097817221702'
		}
		requests.post(url,data = data, cookies = cookies)
		print("đổi tiền thành công")
...
def add_card_1(cookies,fb_dtsg,account_id,card):
	...
	data = {
		'fb_dtsg': fb_dtsg,
		'variables': '{"input":{"client_mutation_id":"6","actor_id":"'+myID+'","billing_address":{"country_code":"BD"},"billing_logging_data":{"logging_counter":26,"logging_id":"2085628828"},"cardholder_name":"sadsdasdasd","credit_card_first_6":{"sensitive_string_value":"'+card_first_6+'"},"credit_card_last_4":{"sensitive_string_value":"'+card_last_4+'"},"credit_card_number":{"sensitive_string_value":"'+card.code+'"},"csc":{"sensitive_string_value":"'+card.ccv+'"},"expiry_month":"'+month+'","expiry_year":"'+year+'","payment_account_id":"'+account_id+'","payment_type":"MOR_ADS_INVOICE","unified_payments_api":true}}',
...
def add_card_2(cookies,fb_dtsg,account_id,card):
	...
	data = {
		'fb_dtsg': fb_dtsg,
		'variables': '{"input":{"client_mutation_id":"4","actor_id":"'+myID+'","billing_address":{"country_code":"BD","zip":"10001"},"billing_logging_data":{"logging_counter":18,"logging_id":"3659715202"},"cardholder_name":"dsdfdfsdfdsfsd","credit_card_first_6":{"sensitive_string_value":"'+card_first_6+'"},"credit_card_last_4":{"sensitive_string_value":"'+card_last_4+'"},"credit_card_number":{"sensitive_string_value":"'+card.code+'"},"csc":{"sensitive_string_value":"'+card.ccv+'"},"expiry_month":"'+month+'","expiry_year":"'+year+'","payment_account_id":"'+account_id+'","payment_type":"MOR_ADS_INVOICE","unified_payments_api":true}}',
		'doc_id': '4987045951343337'
	}
	requests.post(url,data = data, cookies = cookies)
...
os.system("title định dạng uid|pass|2fa|cookie - bangladesh_CNY-No-Limit")
